...
describe('Driver e2e test', () => {
  ...
  it('should load create Driver page', async () => {
    ...
    expect(await driverUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.driver.home.createOrEditLabel/);
  ...
  it('should delete last Driver', async () => {
    ...
    expect(await driverDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.driver.delete.question/);
