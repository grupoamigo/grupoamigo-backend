...
describe('ServiceQuote e2e test', () => {
  ...
  it('should load create ServiceQuote page', async () => {
    ...
    expect(await serviceQuoteUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /grupoamigoBackendApp.serviceQuote.home.createOrEditLabel/
    );
  ...
  it('should delete last ServiceQuote', async () => {
    ...
    expect(await serviceQuoteDeleteDialog.getDialogTitle().getAttribute('id')).to.match(
      /grupoamigoBackendApp.serviceQuote.delete.question/
    );
