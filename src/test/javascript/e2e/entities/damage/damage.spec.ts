...
describe('Damage e2e test', () => {
  ...
  it('should load create Damage page', async () => {
    ...
    expect(await damageUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.damage.home.createOrEditLabel/);
  ...
  it('should delete last Damage', async () => {
    ...
    expect(await damageDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.damage.delete.question/);
