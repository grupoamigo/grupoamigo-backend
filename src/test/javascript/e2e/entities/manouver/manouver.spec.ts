...
describe('Manouver e2e test', () => {
  ...
  it('should load create Manouver page', async () => {
    ...
    expect(await manouverUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.manouver.home.createOrEditLabel/);
  ...
  it('should delete last Manouver', async () => {
    ...
    expect(await manouverDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.manouver.delete.question/);
