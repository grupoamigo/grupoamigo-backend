...
describe('ContactCard e2e test', () => {
  ...
  it('should load create ContactCard page', async () => {
    ...
    expect(await contactCardUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /grupoamigoBackendApp.contactCard.home.createOrEditLabel/
    );
  ...
  it('should delete last ContactCard', async () => {
    ...
    expect(await contactCardDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.contactCard.delete.question/);
