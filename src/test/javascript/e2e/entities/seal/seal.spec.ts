...
describe('Seal e2e test', () => {
  ...
  it('should load create Seal page', async () => {
    ...
    expect(await sealUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.seal.home.createOrEditLabel/);
  ...
  it('should delete last Seal', async () => {
    ...
    expect(await sealDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.seal.delete.question/);
