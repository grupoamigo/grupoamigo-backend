...
describe('Service e2e test', () => {
  ...
  it('should load create Service page', async () => {
    ...
    expect(await serviceUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.service.home.createOrEditLabel/);
  ...
  it('should delete last Service', async () => {
    ...
    expect(await serviceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.service.delete.question/);
