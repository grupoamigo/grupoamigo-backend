...
describe('CountryCode e2e test', () => {
  ...
  it('should load create CountryCode page', async () => {
    ...
    expect(await countryCodeUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /grupoamigoBackendApp.countryCode.home.createOrEditLabel/
    );
  ...
  it('should delete last CountryCode', async () => {
    ...
    expect(await countryCodeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.countryCode.delete.question/);
