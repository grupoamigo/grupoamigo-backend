...
describe('Transport e2e test', () => {
  ...
  it('should load create Transport page', async () => {
    ...
    expect(await transportUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.transport.home.createOrEditLabel/);
  ...
  it('should delete last Transport', async () => {
    ...
    expect(await transportDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.transport.delete.question/);
