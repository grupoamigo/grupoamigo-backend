...
describe('StateCode e2e test', () => {
  ...
  it('should load create StateCode page', async () => {
    ...
    expect(await stateCodeUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.stateCode.home.createOrEditLabel/);
  ...
  it('should delete last StateCode', async () => {
    ...
    expect(await stateCodeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.stateCode.delete.question/);
