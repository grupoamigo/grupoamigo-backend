...
describe('Evidence e2e test', () => {
  ...
  it('should load create Evidence page', async () => {
    ...
    expect(await evidenceUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.evidence.home.createOrEditLabel/);
  ...
  it('should delete last Evidence', async () => {
    ...
    expect(await evidenceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.evidence.delete.question/);
