...
describe('Company e2e test', () => {
  ...
  it('should load create Company page', async () => {
    ...
    expect(await companyUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.company.home.createOrEditLabel/);
  ...
  it('should delete last Company', async () => {
    ...
    expect(await companyDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.company.delete.question/);
