...
describe('Route e2e test', () => {
  ...
  it('should load create Route page', async () => {
    ...
    expect(await routeUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.route.home.createOrEditLabel/);
  ...
  it('should delete last Route', async () => {
    ...
    expect(await routeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.route.delete.question/);
