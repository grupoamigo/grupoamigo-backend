...
describe('Contract e2e test', () => {
  ...
  it('should load create Contract page', async () => {
    ...
    expect(await contractUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.contract.home.createOrEditLabel/);
  ...
  it('should delete last Contract', async () => {
    ...
    expect(await contractDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.contract.delete.question/);
