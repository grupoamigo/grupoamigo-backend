...
describe('Warehouse e2e test', () => {
  ...
  it('should load create Warehouse page', async () => {
    ...
    expect(await warehouseUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.warehouse.home.createOrEditLabel/);
  ...
  it('should delete last Warehouse', async () => {
    ...
    expect(await warehouseDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.warehouse.delete.question/);
