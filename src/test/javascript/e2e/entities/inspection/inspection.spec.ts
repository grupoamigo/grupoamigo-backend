...
describe('Inspection e2e test', () => {
  ...
  it('should load create Inspection page', async () => {
    ...
    expect(await inspectionUpdatePage.getPageTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.inspection.home.createOrEditLabel/);
  ...
  it('should delete last Inspection', async () => {
    ...
    expect(await inspectionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/grupoamigoBackendApp.inspection.delete.question/);
