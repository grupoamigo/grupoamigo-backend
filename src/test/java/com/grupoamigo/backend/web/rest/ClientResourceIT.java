...
import com.grupoamigo.backend.repository.ClientRepository;
import com.grupoamigo.backend.repository.search.ClientSearchRepository;
...
public class ClientResourceIT {
    ...
    private static final UUID DEFAULT_UNIQUE_ID = UUID.randomUUID();
    private static final UUID UPDATED_UNIQUE_ID = UUID.randomUUID();
     ...
     *
     * @see com.grupoamigo.backend.repository.search.ClientSearchRepositoryMockConfiguration
     */
    @Autowired
