...
import com.grupoamigo.backend.repository.search.ManouverSearchRepository;
...
public class ManouverResourceIT {
     ...
     *
     * @see com.grupoamigo.backend.repository.search.ManouverSearchRepositoryMockConfiguration
     */
    @Autowired
