    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="grupoamigoBackendApp.evidence.home.createOrEditLabel">
              <Translate contentKey="grupoamigoBackendApp.evidence.home.createOrEditLabel">Create or edit a Evidence</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
