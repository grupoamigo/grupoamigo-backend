    ...
    return (
      <div>
        <h2 id="evidence-heading">
          <Translate contentKey="grupoamigoBackendApp.evidence.home.title">Evidences</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="grupoamigoBackendApp.evidence.home.createLabel">Create a new Evidence</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('grupoamigoBackendApp.evidence.home.search')}
                  />
        ...
        <div className="table-responsive">
          {evidenceList && evidenceList.length > 0 ? (
            <Table responsive aria-describedby="evidence-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="grupoamigoBackendApp.evidence.name">Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="grupoamigoBackendApp.evidence.file">File</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="grupoamigoBackendApp.evidence.home.notFound">No Evidences found</Translate>
            </div>
          )}
        </div>
      </div>
