  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="grupoamigoBackendApp.inspection.delete.question">
          <Translate contentKey="grupoamigoBackendApp.inspection.delete.question" interpolate={{ id: inspectionEntity.id }}>
