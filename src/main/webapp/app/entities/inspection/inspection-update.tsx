    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="grupoamigoBackendApp.inspection.home.createOrEditLabel">
              <Translate contentKey="grupoamigoBackendApp.inspection.home.createOrEditLabel">Create or edit a Inspection</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
