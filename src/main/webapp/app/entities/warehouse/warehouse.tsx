    ...
    return (
      <div>
        <h2 id="warehouse-heading">
          <Translate contentKey="grupoamigoBackendApp.warehouse.home.title">Warehouses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="grupoamigoBackendApp.warehouse.home.createLabel">Create a new Warehouse</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('grupoamigoBackendApp.warehouse.home.search')}
                  />
        ...
        <div className="table-responsive">
          {warehouseList && warehouseList.length > 0 ? (
              ...
              <tbody>
                {warehouseList.map((warehouse, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`grupoamigoBackendApp.DivisionType.${warehouse.division}`} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="grupoamigoBackendApp.warehouse.home.notFound">No Warehouses found</Translate>
            </div>
          )}
        </div>
      </div>
