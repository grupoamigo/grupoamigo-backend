              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('grupoamigoBackendApp.manouverRequest.home.search')}
                  />
              ...
              <tbody>
                {manouverRequestList.map((manouverRequest, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`grupoamigoBackendApp.TransportType.${manouverRequest.transportType}`} />
                    </td>
                    <td>
