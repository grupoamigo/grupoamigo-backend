  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="grupoamigoBackendApp.driver.delete.question">
          <Translate contentKey="grupoamigoBackendApp.driver.delete.question" interpolate={{ id: driverEntity.id }}>
