    ...
    return (
      <div>
        <h2 id="driver-heading">
          <Translate contentKey="grupoamigoBackendApp.driver.home.title">Drivers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="grupoamigoBackendApp.driver.home.createLabel">Create a new Driver</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('grupoamigoBackendApp.driver.home.search')}
                  />
        ...
        <div className="table-responsive">
          {driverList && driverList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="grupoamigoBackendApp.driver.home.notFound">No Drivers found</Translate>
            </div>
          )}
        </div>
      </div>
