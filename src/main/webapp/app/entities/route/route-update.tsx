    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="grupoamigoBackendApp.route.home.createOrEditLabel">
              <Translate contentKey="grupoamigoBackendApp.route.home.createOrEditLabel">Create or edit a Route</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
