    ...
    return (
      <div>
        <h2 id="transport-heading">
          <Translate contentKey="grupoamigoBackendApp.transport.home.title">Transports</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="grupoamigoBackendApp.transport.home.createLabel">Create a new Transport</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('grupoamigoBackendApp.transport.home.search')}
                  />
        ...
        <div className="table-responsive">
          {transportList && transportList.length > 0 ? (
              ...
              <tbody>
                {transportList.map((transport, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`grupoamigoBackendApp.TransportType.${transport.type}`} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="grupoamigoBackendApp.transport.home.notFound">No Transports found</Translate>
            </div>
          )}
        </div>
      </div>
