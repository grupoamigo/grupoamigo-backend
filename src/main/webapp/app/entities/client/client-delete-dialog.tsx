  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="grupoamigoBackendApp.client.delete.question">
          <Translate contentKey="grupoamigoBackendApp.client.delete.question" interpolate={{ id: clientEntity.id }}>
