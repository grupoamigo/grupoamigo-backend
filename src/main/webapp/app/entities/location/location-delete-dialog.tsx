  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="grupoamigoBackendApp.location.delete.question">
          <Translate contentKey="grupoamigoBackendApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
