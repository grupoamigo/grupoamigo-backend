  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="grupoamigoBackendApp.service.delete.question">
          <Translate contentKey="grupoamigoBackendApp.service.delete.question" interpolate={{ id: serviceEntity.id }}>
