    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="grupoamigoBackendApp.damage.home.createOrEditLabel">
              <Translate contentKey="grupoamigoBackendApp.damage.home.createOrEditLabel">Create or edit a Damage</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
